...
namespace Completed
{
	...
	public class Player : MovingObject
	{
		...
		{
			GameManager.instance.FoodChange(-1);
		...
		private void OnTriggerEnter2D (Collider2D other)
		{
			...
			{
				GameManager.instance.FoodChange(pointsPerFood);
			...
			{
				GameManager.instance.FoodChange(pointsPerSoda);
		...
		public void LoseFood (int loss)
		{
			...
			GameManager.instance.FoodChange(-loss);
